...
<body>
  ...
  <body>
    ...
    <div id="main" class="container-fluid">
      <br>
      <h3 class="page-header">Cliente: <?php echo $nomeUsuario_nomeFantasia ?></h3>
      <hr>
    <!----------------------------------------------------------------------------------------->
      ...
      <div id="actions" class="row">
        <div class="col-md-12">
          <a class="btn btn-dark text-warning" cellspacing="0" cellpadding="0" href="verificaprontuario.php?codigo=<?php echo $dados_detalhes['usuario_instituicaoID'] ?>">Prontuário</a>

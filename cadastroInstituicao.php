...
<?php
    if(isset($_POST["razao_Social"])) {
        ...
        $inserir .= "(razao_Social, nomeUsuario_nomeFantasia, cpf_cnpj, email, senha, telefoneFixo, telefoneFixo2, telefoneCelular, wpp, cep, estado, UF, bairro, rua_avenida, numero, adicional, url, upload_file, tipo) "; 
        $inserir .= "VALUES ";
        $inserir .= "('$razao_Social', '$nomeUsuario_nomeFantasia', '$cpf_cnpj', '$email', '$senha', '$telefoneFixo', '$telefoneFixo2', '$telefoneCelular', '$wpp', '$cep', '$estado', '$UF', '$bairro', '$rua_avenida', '$numero', '$adicional', '$url','semFoto.jpg','2') ";
